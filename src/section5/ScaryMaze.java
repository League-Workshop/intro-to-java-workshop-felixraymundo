...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		...
		//2. Change the line of code above so that it matches your maze's fil name
	...
	public void mouseMoved(MouseEvent e) {
		...
		//ri. Print the mouseColor variable 
		System.out.println(mouseColor);
		
		//6.  Run your program and put your mouse over the background to find out what color it is
		
		//7. Create an ibe background color. 
		int redBackground = -769226;
		int blackBackground = -16777216;
		int blueBackground = -16537100;
		int greenBackground = -7617718;
		//8. If the mouse falls off the path (if it is on the background)
		if ( blackBackground == mouseColor ) {
